...
public class AbbreviationsTest {
  ...
  public void hasClassAbbreviations() {
    assertTrue(
        "Class Abbreviations not found. Make sure it is defined \"public class Abbreviations"
            + " {\"...",
        Reflex.reflect("Abbreviations").isPublic());
  }

  @Test
  public void hasMethodAddAbbreviation() {
    Reflex.reflect("Abbreviations")
        .method("addAbbreviation")
        .returningVoid()
  ...
  public void addFindAndRemoveAbbreviation() throws Throwable {
    ...
    Reflex.reflect("Abbreviations")
        ...
        .returningVoid()
        .taking(String.class, String.class)
        .invokeOn(abbreviations, "lol", "laughing out loud");
    Reflex.reflect("Abbreviations")
        .method("addAbbreviation")
        .returningVoid()
        .taking(String.class, String.class)
        .invokeOn(abbreviations, "etc", "and so on");
    ...
    assertFalse(
        "Method hasAbbreviation failed. Try:\n" + codeToTest,
        Reflex.reflect("Abbreviations")
            .method("hasAbbreviation")
            .returning(boolean.class)
            .taking(String.class)
            .invokeOn(abbreviations, "lmao"));
    assertTrue(
        "Method hasAbbreviation failed. Try:\n" + codeToTest,
        Reflex.reflect("Abbreviations")
            .method("hasAbbreviation")
            .returning(boolean.class)
            .taking(String.class)
            .invokeOn(abbreviations, "etc"));

    assertNull(
        "Method findExplanationFor failed. Try:\n" + codeToTest,
        Reflex.reflect("Abbreviations")
            .method("findExplanationFor")
            .returning(String.class)
            .taking(String.class)
